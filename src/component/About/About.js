...
const About = () => {
    return (
        <div className="d-flex bg-dark text-light">
                    ...
                    <img src={"https://image.freepik.com/free-photo/top-view-photography-accesories-with-copy-space_23-2148363427.jpg"} alt="" srcset="" />
                </div>
    );
};
